    ...
    <header className="w-full bg-gradient-to-r from-pink-100 to-pink-200 py-20">
      <div className="container mx-auto px-4 py-4">
        <nav className="flex items-center justify-between">
          <h1 className="text-2xl font-display font-bold text-primary-light">yaneh.design</h1>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
          <div className="max-w-2xl mx-auto text-center md:text-center">
            <h2 className="text-6xl md:text-8xl font-display font-bold mb-6 text-primary-light animate-fade-in">
              Design that
              <br />
              makes waves
            </h2>
